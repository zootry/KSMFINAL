...
<section class="hero-wrap hero-wrap-2">
	<div class="container text-center d-flex justify-content-center">
		<div class="no-gutters align-items-end" style="margin-top:100px; border-bottom:solid 3px #c1b8f2;">
			<h1 class="mb-0 bread text-dark">내가 쓴 게시물</h1>
			<p class="breadcrumbs mb-2"><span class="text-dark">My Gallery</span></p>
		</div>
	</div>
</section>
			...
			<c:choose>
				<c:when test="${empty galleryMyList}">
					<div class="col-12 mt-5 mb-5">
						...
						<h5 class="text-center">등록한 게시물이 없습니다. 게시물을 <a href="/freeboard/galleryWrite" style="color:#a091f3">등록</a>해주세요!</h5>
					</div>
				</c:when>
				<c:otherwise>
						...
						<div class="col-sm-6 col-md-4">
							<div class="card text-white">
								...
								<div class="card-img-overlay">
									...
									data-gseq="${myGallery.g_seq}" data-email="${myGallery.email}" data-cont="${myGallery.content}" 
									data-likes="${myGallery.likes}" data-wdate="${myGallery.wdate}"	data-imgs="${imgNames[status.index]}">
									<span class="card-text">
										<i class="bi bi-clock"></i>${myGallery.wdate}
										<i class="bi bi-heart-fill"></i><span id="heart_Data${myGallery.g_seq}">${myGallery.likes}</span>
										<h5 class="card-title text-white" id="contentTitle"><b>${myGallery.content}</b></h5>
									</span> 
									</a>
								</div>
							</div>	
